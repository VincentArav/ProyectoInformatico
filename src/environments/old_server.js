...
app.post('/ADDMaterial/:id',bodyParser.json(),(req,res)=>{ 
    ...
    const select_query=`INSERT INTO materiales (nombre_m, descripcion_m)
...
app.get('/ListadoMateriales',(req,res)=>{ 
    var id = req.params.id;
    const select_query=`SELECT * FROM materiales`;
    client.query(select_query,(err,result)=>{
        console.log(result);
      if(err){
          return res.send(err)
...
app.get('/ListadoLugares',(req,res)=>{ 
    var id = req.params.id;
    const select_query=`SELECT * FROM lugar`;
    client.query(select_query,(err,result)=>{
        console.log(result);
      if(err){
          return res.send(err)
...
app.post('/ADDSolicitud/:id',bodyParser.json(),(req,res)=>{
    var id = req.params.id;
    const select_query=`INSERT INTO orden (rut_u)
